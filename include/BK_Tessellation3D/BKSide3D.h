...
#include "../BK_Algorithm/BOC/BOC.h"
#include <fenv.h>
...
namespace BKHao
{
	...
	private:
		...
		static inline _BOC::_Sign base_side1_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double w1, double w2, double qx, double qy, double qz);
		template <class RT> 
		...
		static _BOC::_Sign base_side2_(
			double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double w1, double w2, double w3, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z);
		template <class RT> 
		...
		static _BOC::_Sign base_side3_(
			double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double p4x, double p4y, double p4z, double w1, double w2, double w3, double w4, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z, double q3x, double q3y, double q3z);
		template <class RT> 
