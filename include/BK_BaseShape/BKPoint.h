...
namespace BKHao
{
	...
	public:
		...
		{
			double det = v0.x() * (v1.y() * v2.z() - v1.z() * v2.y()) - v0.y() * (v1.x() * v2.z() - v1.z() * v2.x()) + v0.z() * (v1.x() * v2.y() - v1.y() * v2.x());
			double x = -d0 * (v1.y() * v2.z() - v1.z() * v2.y()) - v0.y() * (-d1 * v2.z() + v1.z() * d2) + v0.z() * (-d1 * v2.y() + v1.y() * d2);
			x /= det;
			double y = v0.x() * (-d1 * v2.z() + v1.z() * d2) + d0 * (v1.x() * v2.z() - v1.z() * v2.x()) + v0.z() * (-d2 * v1.x() + d1 * v2.x());
			y /= det;
			double z = v0.x() * (-d2 * v1.y() + d1 * v2.y()) - v0.y() * (-d2 * v1.x() + d1 * v2.x()) - d0 * (v1.x() * v2.y() - v1.y() * v2.x());
			z /= det;
