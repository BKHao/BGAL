...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side1_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double w1, double w2, double qx, double qy, double qz)
{
...
template <class RT>
RT BKHao::_Side3D::side1_generic(
...
BKHao::_Side3D::Comparison_result BKHao::_Side3D::side1_filtered(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double w1, double w2, double qx, double qy, double qz)
{
	{
		C2F c2f;
...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side2_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double w1, double w2, double w3, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z)
{
...
template<class RT>
void BKHao::_Side3D::side2_generic(RT& result, RT& denom, const RT& p1x, const RT& p1y, const RT& p1z, const RT& p2x, const RT& p2y, const RT& p2z, const RT& p3x, const RT& p3y, const RT& p3z, const RT& w1, const RT& w2, const RT& w3, const RT& q1x, const RT& q1y, const RT& q1z, const RT& q2x, const RT& q2y, const RT& q2z)
{
	static RT const two(2);
...
BKHao::_Side3D::Comparison_result BKHao::_Side3D::side2_filtered(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double w1, double w2, double w3, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z)
{
	{
		C2F c2f;
		FK::FT result;
...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side3_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double p4x, double p4y, double p4z, double w1, double w2, double w3, double w4, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z, double q3x, double q3y, double q3z)
{
...
template<class RT>
void BKHao::_Side3D::side3_generic(RT& result, RT& denom, const RT& p1x, const RT& p1y, const RT& p1z, const RT& p2x, const RT& p2y, const RT& p2z, const RT& p3x, const RT& p3y, const RT& p3z, const RT& p4x, const RT& p4y, const RT& p4z, const RT& w1, const RT& w2, const RT& w3, const RT& w4, const RT& q1x, const RT& q1y, const RT& q1z, const RT& q2x, const RT& q2y, const RT& q2z, const RT& q3x, const RT& q3y, const RT& q3z)
{
	static RT const two(2);
...
BKHao::_Side3D::Comparison_result BKHao::_Side3D::side3_filtered(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double p4x, double p4y, double p4z, double w1, double w2, double w3, double w4, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z, double q3x, double q3y, double q3z)
{
	{
		C2F c2f;
		FK::FT result;
...
BKHao::_BOC::_Sign BKHao::_Side3D::side1_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double w1, double w2, double qx, double qy, double qz)
{
...
BKHao::_BOC::_Sign BKHao::_Side3D::side2_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double w1, double w2, double w3, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z)
{
...
BKHao::_BOC::_Sign BKHao::_Side3D::side3_(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z, double p3x, double p3y, double p3z, double p4x, double p4y, double p4z, double w1, double w2, double w3, double w4, double q1x, double q1y, double q1z, double q2x, double q2y, double q2z, double q3x, double q3y, double q3z)
{
