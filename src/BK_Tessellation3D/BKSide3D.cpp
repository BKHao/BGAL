...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side1_(double p1x,
                                               double p1y,
                                               double p1z,
                                               double p2x,
                                               double p2y,
  ...
  if (((fabs((((v1x * v2x) + (v1y * v2y)) + (v1z * v2z) + w1 - w2))
      > ((((v1x_bound * v2x_bound) + (v1y_bound * v2y_bound)) + (v1z_bound * v2z_bound) + fabs(w1) + fabs(w2))
...
BKHao::_Side3D::Comparison_result BKHao::_Side3D::side1_filtered(double p1x,
                                                                 double p1y,
                                                                 double p1z,
                                                                 double p2x,
                                                                 double p2y,
...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side2_(double p1x,
                                               double p1y,
                                               double p1z,
                                               double p2x,
                                               double p2y,
  ...
  result_bound = (((((t28_bound * t19_bound) + (t26_bound * t18_bound)) + (t24_bound * t17_bound))
      * ((((p3x_bound + t27_bound) * t22_bound) + ((p3y_bound + t25_bound) * t21_bound))
          + ((p3z_bound + t23_bound) * t20_bound) + fabs(w1) + fabs(w3)))
      + ((((t28_bound * (p2x_bound + t27_bound)) + (t26_bound * (p2y_bound + t25_bound)))
          + (t24_bound * (p2z_bound + t23_bound)) + fabs(w1) + fabs(w2)) * denom_bound));
...
template<class RT>
void BKHao::_Side3D::side2_generic(RT &result,
                                   RT &denom,
                                   const RT &p1x,
                                   const RT &p1y,
                                   const RT &p1z,
...
BKHao::_Side3D::Comparison_result BKHao::_Side3D::side2_filtered(double p1x,
                                                                 double p1y,
                                                                 double p1z,
                                                                 double p2x,
                                                                 double p2y,
...
BKHao::_BOC::_Sign BKHao::_Side3D::base_side3_(double p1x,
  ...
  double t55_bound;
  double t55;
  t55_bound = (((t48_bound * (p1x_bound + p4x_bound)) + (t47_bound * (p1y_bound + p4y_bound)))
      + (t46_bound * (p1z_bound + p4z_bound))) + fabs(w1) + fabs(w4);
  ...
  double t54_bound;
  double t54;
  t54_bound = (((t51_bound * (p1x_bound + p3x_bound)) + (t50_bound * (p1y_bound + p3y_bound)))
      + (t49_bound * (p1z_bound + p3z_bound))) + fabs(w1) + fabs(w4);
  ...
  double result_bound;
  double result;
  result_bound = ((((p1x_bound + p2x_bound)
      * ((((t33_bound * t54_bound) + (((t49_bound * t37_bound) + (t50_bound * t39_bound)) * t55_bound))
          + (((t50_bound * t46_bound) + (t49_bound * t47_bound)) * t53_bound))
          + (denom_bound * (p1x_bound + p2x_bound)))) + ((p1y_bound + p2y_bound)
      * ((((t32_bound * t54_bound) + (((t51_bound * t39_bound) + (t49_bound * t38_bound)) * t55_bound))
          + (((t49_bound * t48_bound) + (t51_bound * t46_bound)) * t53_bound))
          + (denom_bound * (p1y_bound + p2y_bound))))) + ((p1z_bound + p2z_bound)
      * ((((t34_bound * t54_bound) + (((t50_bound * t38_bound) + (t51_bound * t37_bound)) * t55_bound))
          + (((t51_bound * t47_bound) + (t50_bound * t48_bound)) * t53_bound))
          + (denom_bound * (p1z_bound + p2z_bound))))) + (fabs(w1) + fabs(w2)) * denom_bound;
  result = ((((p1x - p2x) * ((((t33 * t54) + (((t49 * t37) - (t50 * t39)) * t55)) + (((t50 * t46) - (t49 * t47)) * t53))
      - (denom * (p1x + p2x)))) + ((p1y - p2y)
      * ((((t32 * t54) + (((t51 * t39) - (t49 * t38)) * t55)) + (((t49 * t48) - (t51 * t46)) * t53))
          - (denom * (p1y + p2y))))) + ((p1z - p2z)
      * ((((t34 * t54) + (((t50 * t38) - (t51 * t37)) * t55)) + (((t51 * t47) - (t50 * t48)) * t53))
          - (denom * (p1z + p2z))))) + (w1 - w2) * denom;
  _BOC::_Sign int_tmp_result_FFWKCAA;
...
template<class RT>
void BKHao::_Side3D::side3_generic(RT &result,
                                   RT &denom,
                                   const RT &p1x,
                                   const RT &p1y,
                                   const RT &p1z,
  ...
  result =
      (p1x - p2x) * (t33 * t54 + (t49 * t37 - t50 * t39) * t55 + (t50 * t46 - t49 * t47) * t53 - denom * (p1x + p2x)) +
          (p1y - p2y)
              * (t32 * t54 + (t51 * t39 - t49 * t38) * t55 + (t49 * t48 - t51 * t46) * t53 - denom * (p1y + p2y)) +
          (p1z - p2z)
              * (t34 * t54 + (t50 * t38 - t51 * t37) * t55 + (t51 * t47 - t50 * t48) * t53 - denom * (p1z + p2z)) +
          (w1 - w2) * denom;
}
...
BKHao::_BOC::_Sign BKHao::_Side3D::side1_(double p1x,
                                          double p1y,
                                          double p1z,
                                          double p2x,
                                          double p2y,
  ...
  if (result == _BOC::_Sign::FaileD) {
    ...
    result =
        (r == Comparison_result::ZERO ? _BOC::_Sign::ZerO : (r == Comparison_result::POSITIVE ? _BOC::_Sign::PositivE
                                                                                              : _BOC::_Sign::NegativE));
  }
  return result;
}

BKHao::_BOC::_Sign BKHao::_Side3D::side2_(double p1x,
                                          double p1y,
                                          double p1z,
                                          double p2x,
                                          double p2y,
