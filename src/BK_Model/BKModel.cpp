...
_Model::_MFace::_MFace(const int &id1, const int &id2, const int &id3) : _Triangle3(), id(-1) {
  ...
  _vertices[0] = id1;
	...
	_Model::_MFace::_MFace(const int& id1, const int& id2, const int& id3, const _Point3& p1, const _Point3& p2, const _Point3& p3)
	...
	void _Model::save_obj_file_(const std::string& in_file_name) const
	{
		...
		out << "g " << in_file_name.substr(in_file_name.rfind("\\") + 1, in_file_name.rfind('.') - in_file_name.rfind("\\") - 1) << std::endl;
