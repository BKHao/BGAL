...
void _Marching_Tetrahedra::tiling_() {
  double box = 1.1
      * std::max(_boundingbox.second.x() - _boundingbox.first.x(), _boundingbox.second.y() - _boundingbox.first.y());
  ...
  int height =
      (int) (((_boundingbox.second.z() + 0.1 * (_boundingbox.second.z() - _boundingbox.first.z())) - lu.z() - 2.0 * a)
          / (3.0 * a)) + 1;
